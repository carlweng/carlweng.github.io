...
\begin{center}
    ...
    \href{https://carlweng.github.io}{carlweng.github.io}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Designing and Developing secure multi-party computation and differential privacy applications for online conversion measurement.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Designing zero-knowledge protocols for boolean and arithmetic circuits}
        \resumeItem{Protocol implementation and evaluation}
      \resumeItemListEnd
...
%-------------------------------------------
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Implementing threshold encryption and digital signature schemes based on MPC}
        \resumeItem{Implementing private set intersection protocol and order-preserving encryption scheme}
      \resumeItemListEnd
...
\begin{enumerate}[leftmargin=0.20in]
  \item
	  \small Jul. 2021 - "Efficient Conversions for Zero-Knowledge Proofs with Applications to Machine Learning", USENIX Security Symposium, 2021.
  \item
...
\section{Software}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \resumeDevHeading
      {\small EMP library}
		 \begin{enumerate}
			 \item \small {[EMP-TOOL] Float-point circuits, utility functions}
			 \item \small {[EMP-OT] Correlated-OT based on VOLE (The Ferret protocol)}
			 \item \small {[EMP-ZK] Implementation of interactive zero-knowledge proof protocols. For the circuit model, it supports boolean and arithmetic circuits, and their conversions. It also supports proving degree-2 polynomial satisfiabilies.}
		 \end{enumerate}
    %\resumeDevHeading
