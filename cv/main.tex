...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Research Intern}{Evanston, IL}
      {Microsoft Research}{May. 2021 -- present}
      \resumeItemListStart
        \resumeItem{Designing and Developing secure multi-party computation and differential privacy applications.}
      \resumeItemListEnd
...
\begin{enumerate}[leftmargin=0.20in]
  \item
	  \small May. 2021 - (Incoming) "Wolverine: Fast, Scalable, and Communication-Efficient Zero-Knowledge Proofs for Boolean and Arithmetic Circuits", IEEE Security \& privacy (Oakland), 2021.
  \item
    ...
    \resumeDevHeading
      {\small EMP library}
		 \begin{enumerate}
			 ...
			 \item \small {[EMP-ZK] Implementation of zero-knowledge proof protocols for boolean and arithmetic circuits}
		 \end{enumerate}
    %\resumeDevHeading
